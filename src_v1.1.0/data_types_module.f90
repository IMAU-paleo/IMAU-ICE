MODULE data_types_module
  ...
  TYPE type_ice_model
    ...
    INTEGER :: wD_SIA_3D_Acx, wD_SIA_3D_Acy, wD_SIA_Acx, wD_SIA_Acy, wD_SIA_Aa
    ...
    ! Thermodynamics
    REAL(dp), DIMENSION(:,:  ), POINTER     :: frictional_heating_Aa
    REAL(dp), DIMENSION(:,:  ), POINTER     :: Fr_Aa
    INTEGER :: wfrictional_heating_Aa, wFr_Aa
    ...
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_01
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_02
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_03
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_04
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_05
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_06
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_07
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_08
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_09
    REAL(dp), DIMENSION(:,:  ), POINTER     :: dummy2D_10
    INTEGER :: wdummy2D_01, wdummy2D_02, wdummy2D_03, wdummy2D_04, wdummy2D_05, wdummy2D_06, wdummy2D_07, wdummy2D_08, wdummy2D_09, wdummy2D_10
    
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_01
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_02
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_03
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_04
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_05
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_06
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_07
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_08
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_09
    REAL(dp), DIMENSION(:,:,:), POINTER     :: dummy3D_10
    INTEGER :: wdummy3D_01, wdummy3D_02, wdummy3D_03, wdummy3D_04, wdummy3D_05, wdummy3D_06, wdummy3D_07, wdummy3D_08, wdummy3D_09, wdummy3D_10
  ...
  TYPE type_subclimate_global
    ...
    INTEGER :: wT2m, wPrecip, wHi, wHs, wWind_WE, wWind_SN ! MPI windows to all these memory spaces
  ...
  TYPE type_subclimate_region
    ...
    INTEGER :: wT2m, wPrecip, wHi, wHs, wWind_WE, wWind_SN, wWind_LR, wWind_DU ! MPI windows to all these memory spaces
    
    ! Elevation- and bias-corrected climate and spatially variables lapse rate for GCM snapshots (see Berends et al., 2018)
    REAL(dp), DIMENSION(:,:,:), POINTER     :: T2m_pot
    REAL(dp), DIMENSION(:,:,:), POINTER     :: T2m_pot_corr
    REAL(dp), DIMENSION(:,:,:), POINTER     :: Precip_corr
    REAL(dp), DIMENSION(:,:  ), POINTER     :: Hs_corr
    REAL(dp), DIMENSION(:,:  ), POINTER     :: lambda
    INTEGER :: wT2m_pot, wT2m_pot_corr, wPrecip_corr, wHs_corr, wlambda
    
    ! Reference absorbed insolation (for GCM snapshots)
    ...
    REAL(dp), DIMENSION(:,:  ), POINTER     :: I_abs                         ! Total yearly absorbed insolation (J/m2), used in the climate matrix for interpolation
  ...
  TYPE type_SMB_model
    ...
    INTEGER :: wRefreezing, wRefreezing_year, wRunoff, wAlbedo, wSMB, wSMB_year
  ...
  TYPE type_model_region
    ...
    ! Output netcdf files
    TYPE(type_netcdf_output)                :: restart
    TYPE(type_netcdf_output)                :: help_fields

...
Dims{ 1}.Opts{ 1}.Vars{ 4}.Value = 'MISMIPplus/MISMIPplus_init_5km_slid1_DIVA/restart_ANT.nc';

Dims{ 1}.Opts{ 2}.suffix         = '_2km';
Dims{ 1}.Opts{ 2}.Vars{ 1}.Name  = 'dx_ANT_config';
Dims{ 1}.Opts{ 2}.Vars{ 1}.Value = '2000';
Dims{ 1}.Opts{ 2}.Vars{ 2}.Name  = 'MISMIPplus_sliding_law_config';
Dims{ 1}.Opts{ 2}.Vars{ 2}.Value = '1';
Dims{ 1}.Opts{ 2}.Vars{ 3}.Name  = 'MISMIPplus_A_flow_initial_config';
Dims{ 1}.Opts{ 2}.Vars{ 3}.Value = '1.517E-17';
Dims{ 1}.Opts{ 2}.Vars{ 4}.Name  = 'filename_init_ANT_config';
Dims{ 1}.Opts{ 2}.Vars{ 4}.Value = 'MISMIPplus/MISMIPplus_init_2km_slid1_DIVA/restart_ANT.nc';
...
%% The three sub-grid melt schemes
Dims{ 3}.Opts{ 1}.suffix         = '_NMP';
Dims{ 3}.Opts{ 1}.Vars{1}.Name   = 'choice_BMB_subgrid_config';
Dims{ 3}.Opts{ 1}.Vars{1}.Value  = 'NMP';

Dims{ 3}.Opts{ 2}.suffix         = '_FCMP';
Dims{ 3}.Opts{ 2}.Vars{1}.Name   = 'choice_BMB_subgrid_config';
Dims{ 3}.Opts{ 2}.Vars{1}.Value  = 'FCMP';

Dims{ 3}.Opts{ 3}.suffix         = '_PMP';
Dims{ 3}.Opts{ 3}.Vars{1}.Name   = 'choice_BMB_subgrid_config';
Dims{ 3}.Opts{ 3}.Vars{1}.Value  = 'PMP';

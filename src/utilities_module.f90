...
! == Linear least-squares fit
  SUBROUTINE linear_least_squares_fit( x, y, n, y0, dydx)
    ! Fit the linear function y = y0 + x dy/dx using a least-squares regression
    ...
    dydx = (n * sumxy - sumy*sumx) / (n * sumx2 - sumx**2)
    y0   = (sumy - dydx * sumx) / n

  END SUBROUTINE linear_least_squares_fit

...
foldernames = {...
  'phase2_glacialinception/hybrid_ZoetIverson_PMIP3ens_40km',...
  'phase2_glacialinception/hybrid_ZoetIverson_PMIP3ens_30km',...
  'phase2_glacialinception/hybrid_ZoetIverson_PMIP3ens_20km',...
  'phase2_glacialinception/hybrid_ZoetIverson_PMIP3ens_16km',...
  'phase2_glacialinception/hybrid_ZoetIverson_PMIP3ens_10km',...
  'phase2_glacialinception/hybrid_ZoetIverson_HadCM3_20km',...
  'phase2_glacialinception/hybrid_ZoetIverson_CCSM_20km',...
  'phase2_glacialinception/hybrid_Coulombreg_PMIP3ens_20km'};
...
for fi = 1: length( foldernames)
  ...
  filename_refice = 'deglacial_retreat_mask_refice.nc';
  ...
  % Write x,y,time
  ncwrite( filename,'x'     ,LGM.x      );
  ncwrite( filename,'y'     ,LGM.y      );
  ncwrite( filename,'time'  ,time_netcdf);
  ncwrite( filename,'sftgif',sftgif     );

  %% Create reference ice thickness for the retreat mask
  create_refice_file( foldername, filename_refice)
...
function create_refice_file( foldername, filename_refice)

disp('Creating reference ice thickness for the retreat mask...')
...
filename = [foldername '/' filename_refice];
if exist( filename,'file')
  delete( filename)
end

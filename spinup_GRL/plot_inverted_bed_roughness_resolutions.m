...
foldernames = {...
  'phase1a_finecalibration/hybrid_ZoetIverson_40km',...          %  1
  'phase1a_finecalibration/hybrid_ZoetIverson_30km',...          %  2
  'phase1a_finecalibration/hybrid_ZoetIverson_20km',...          %  3
...
% Surface elevation
image('parent',H.Ax( 2,1),'xdata',results( 5).x,'ydata',results( 5).y,'cdata',results( 5).Hs_target','cdatamapping','scaled',...
  'alphadata',double( results( 5).TAF' > 0));

% Surface velocity
image('parent',H.Ax( 3,1),'xdata',results( 5).x,'ydata',results( 5).y,'cdata',results( 5).uabs_surf_target','cdatamapping','scaled',...
  'alphadata',double( results( 5).TAF' > 0));
...
for j = 1:5
  ...
  image('parent',H.Ax( 1,j+1),'xdata',results( j).x,'ydata',results( j).y,'cdata',results( j).phi_fric','cdatamapping','scaled',...
    'alphadata',double( results( j).TAF' > 0));
